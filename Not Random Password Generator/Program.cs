        ...
        static void Main(string[] args)
        {
            for (; ; )
            {
                try
                {
                    ...
                    Console.WriteLine("Welcome to the NOT Random Password Generator!!");

                    Console.Write("This is ");
                    Console.ForegroundColor = ConsoleColor.Red;
                    Console.Write("NOT");
                    Console.ForegroundColor = ConsoleColor.Gray;
                    Console.WriteLine(" recommended for using as your actual password, as it uses all the lowercase letters available on a modern keyboard.");
